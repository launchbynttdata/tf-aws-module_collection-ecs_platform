...
| <a name="input_private_subnet_cidr_ranges"></a> [private\_subnet\_cidr\_ranges](#input\_private\_subnet\_cidr\_ranges) | List of private subnet CIDR ranges for the VPC | `list(string)` | <pre>[<br>  "10.1.1.0/24",<br>  "10.1.2.0/24",<br>  "10.1.3.0/24"<br>]</pre> | no |
| <a name="input_public_subnet_cidr_ranges"></a> [public\_subnet\_cidr\_ranges](#input\_public\_subnet\_cidr\_ranges) | List of public subnet CIDR ranges for the VPC | `list(string)` | `[]` | no |
